<template>
          <section class="text-white bg-purple-700">
            <div class="container items-center px-5 py-8 mx-auto lg:px-24">
              <div class="flex flex-wrap mb-12 text-left">
                <div class="w-full mx-auto lg:w-1/6">
                  <div class="p-6">
                    <div class="inline-flex items-center justify-center flex-shrink-0 w-12 h-12 mx-auto mb-5 text-white bg-blueGray-100 rounded-full">
                    ...
                    <h1 class="mx-auto mb-8 text-2xl font-semibold leading-none tracking-tighter text-white lg:text-3xl title-font">Item 1</h1>
                    <p class="mx-auto text-base font-medium leading-relaxed text-white ">Descrição</p>
                  </div>
